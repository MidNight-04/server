...
module.exports = function (app) {
    ...
    app.post("/api/constructionstep/add",uploadImage.fields([
        {
        name: 'points', maxCount: 10
    }
    ...
    app.put("/api/constructionstep/addnewfield", controller.addNewFieldConstructionStepById);
