...
module.exports = function (app) {
    ...
    app.get("/api/user/single-profile/:id", controller.singleProfile);
    app.post("/api/user/details", controller.getUsersDetails);
    // login after otp verification
    app.post("/api/auth/login", controller.login);
    // getcities list for 
    app.post("/api/auth/getCities", controller.getCities);
    app.post("/api/auth/getStates", controller.getStates);
    // complete profile api
    app.post("/api/auth/completeProfile", controller.completeProfile);
    // get user details
    app.get("/api/auth/getProfile", controller.getProfile);
    ...
    // Address api
    app.post("/api/user/add-address", uploadImage.fields([]), controller.addAddress);
    app.post("/api/user/update-address",uploadImage.fields([]), controller.updateAddress);
    ...
    app.post('/api/user/update-request-phone-number', controller.requestUpdatePhoneNumber)
    ...
    app.post('/api/user/update-order-status', uploadImage.fields([
        {
    ...
    app.post("/api/user/get-product-rating-by-id", controller.getProductRatingById);
    app.post("/api/user/get-rating-by-product-id", controller.getRatingByProductId);
